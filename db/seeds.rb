...
Comment.create(author: "user1@example.com", content: "A veces estudio poco", post_id: 8)
Comment.create(author: "user1@example.com", content: "pero enseño estadistica asi que ya no integro :(", post_id: 9)
Comment.create(author: "user1@example.com", content: "creo que me falto un comentario", post_id: 10)